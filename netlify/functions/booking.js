...
body: `<p style="font-size:16px;margin-bottom:16px">Hi <strong>${clientName}</strong>! 🎉</p> <p style="color:#A78BCA;line-height:1.7;margin-bottom:20px">Great news — your Funky Monkey Event is officially <strong style="color:#10B981">CONFIRMED!</strong> To lock in your date, please pay your deposit below.</p> <div style="background:#1A1035;border-radius:12px;padding:16px;margin-bottom:20px"> <div style="margin-bottom:10px"><span style="color:#A78BCA;font-size:11px;text-transform:uppercase;font-weight:700">Service</span><br><span style="font-weight:600">${serviceName}</span></div> <div style="margin-bottom:10px"><span style="color:#A78BCA;font-size:11px;text-transform:uppercase;font-weight:700">Date & Time</span><br><span style="font-weight:600">${eventDate} at ${eventTime}</span></div> <div style="margin-bottom:10px"><span style="color:#A78BCA;font-size:11px;text-transform:uppercase;font-weight:700">Location</span><br><span style="font-weight:600">${eventLocation}</span></div> <div style="margin-bottom:10px"><span style="color:#A78BCA;font-size:11px;text-transform:uppercase;font-weight:700">Deposit Due</span><br><span style="color:#FFD600;font-weight:900;font-size:22px">$${depositAmount.toFixed(2)}</span></div> <div><span style="color:#A78BCA;font-size:11px;text-transform:uppercase;font-weight:700">Balance Due Day of Event</span><br><span style="color:#F3E8FF;font-weight:700">$${balanceDue.toFixed(2)}</span></div> </div> ${stripeLink ? `<div style="text-align:center;margin-bottom:20px">
...
</div>` : ""} <p style="font-size:13px;color:#A78BCA;text-align:center">Questions? <a href="tel:4054316625" style="color:#06B6D4;font-weight:700">(405) 431-6625</a></p>`
},
cancelled: {
subject: “Booking update — Funky Monkey Events”,
body: `<p style="font-size:16px;margin-bottom:16px">Hi <strong>${clientName}</strong>,</p> <p style="color:#A78BCA;line-height:1.7;margin-bottom:20px">Unfortunately we weren't able to confirm your booking for <strong>${serviceName}</strong> on <strong>${eventDate}</strong>. We're sorry for any inconvenience!</p> <p style="color:#A78BCA;line-height:1.7;margin-bottom:20px">We'd love to find a date that works — please give us a call or submit a new request.</p> <div style="text-align:center"><a href="${SITE}/booking-form.html" style="background:linear-gradient(135deg,#FF6B00,#FFD600);color:#0F0A1E;padding:12px 28px;border-radius:10px;text-decoration:none;font-weight:900;font-size:14px">Request a New Date →</a></div> <p style="font-size:13px;color:#A78BCA;text-align:center;margin-top:20px"><a href="tel:4054316625" style="color:#06B6D4;font-weight:700">(405) 431-6625</a></p>`
},
completed: {
subject: “How did we do? 🌟 — Funky Monkey Events”,
body: `<p style="font-size:16px;margin-bottom:16px">Hi <strong>${clientName}</strong>! 🎉</p> <p style="color:#A78BCA;line-height:1.7;margin-bottom:20px">Thank you SO much for choosing Funky Monkey Events! We hope everyone had an absolutely <strong style="color:#FFD600">AMAZING</strong> time!</p> <p style="color:#A78BCA;line-height:1.7;margin-bottom:20px">A quick review means the world to us:</p> <div style="text-align:center;margin-bottom:24px"><a href="https://funkymonkeyevents.com" style="background:linear-gradient(135deg,#FF6B00,#FFD600);color:#0F0A1E;padding:14px 32px;border-radius:10px;text-decoration:none;font-weight:900;font-size:15px">⭐ Leave a Review</a></div> <div style="background:#064E3B22;border:1px solid #10B98133;border-radius:12px;padding:14px;text-align:center"> <p style="color:#6EE7B7;font-weight:800;margin-bottom:4px">Come back and save! 🐒</p> <p style="color:#A78BCA;font-size:13px">Returning clients get <strong style="color:#10B981">10% off</strong> their next booking.</p> </div>`
}
};
